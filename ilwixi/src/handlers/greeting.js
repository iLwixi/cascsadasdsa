...
const buildGreeting = async (member, type, config, inviterData) => {
  ...
  if (!config.content && !config.embed.description && !config.embed.footer) {
    content =
      type === "WELCOME"
        ? `╭・<a:bstt:1147156005642305546>・ ${member.user.tag} Katıldı.
        ●▬▬▬▬▬▬▬▬๑۩✰۩๑▬▬▬▬▬▬▬▬●
        <a:diamon:1147155962512298054>・ Hoşgeldin @${member.user.tag} !
        <a:diamon:1147155962512298054>・ Davet eden  ||'Bilinmiyor'} !
        <a:diamon:1147155962512298054>・ ${member.guild.name} Sunucusu seninle beraber ${member.guild.memberCount} kişi oldu!
        ●▬▬▬▬▬▬▬▬๑۩✰۩๑▬▬▬▬▬▬▬▬●
        ╰・<a:bstt:1147156005642305546>・ .  🎉`
        : `${member.user.tag} **Çıkış Yaptı** 👋`;
    return { content };
  }
