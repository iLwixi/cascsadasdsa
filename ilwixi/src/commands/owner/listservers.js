...
module.exports = {
  name: "sunuculistesi",
  description: "Tüm/eşleşen sunucuları listeler",
  category: "OWNER",
  ...
  async messageRun(message, args) {
    ...
    const buildEmbed = () => {
      ...
      const embed = new EmbedBuilder()
        ...
        .setAuthor({ name: "Sunucular listesi" })
        .setFooter({ text: `${match ? "Eşleşmiş" : "Toplam"} Sunucular: ${total} • Sayfa ${currentPage} ile ilgili ${totalPages}` });
