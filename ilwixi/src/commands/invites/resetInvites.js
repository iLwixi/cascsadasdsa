...
module.exports = {
  name: "resetinvites",
  description: "bir kullanıcının davet ettiklerini temizle",
  category: "INVITE",
  ...
  slashCommand: {
    ...
    options: [
      {
        name: "user",
        description: "kullanıcı davetiyeleri temizlemek için",
...
async function clearInvites({ guild }, user) {
  ...
  return `Tamamlamak!Temizlenmiş davetler \`${user.tag}\``;
}
