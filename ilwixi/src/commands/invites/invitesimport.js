...
module.exports = {
  name: "invitesimport",
  description: "Kullanıcılara mevcut lonca davetlerini ekleyin",
  category: "INVITE",
  ...
  slashCommand: {
    ...
    options: [
      {
        name: "user",
        description: "Kullanıcı davetiyeleri içe aktaracak",
...
async function importInvites({ guild }, user) {
  if (user && user.bot) return "Oops!Botlar için davet içe aktaramazsınız";
  ...
  return `Tamamlamak!Önceki davetler eklendi ${user ? user.tag : "all members"}`;
}
