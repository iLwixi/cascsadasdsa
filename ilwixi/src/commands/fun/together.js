...
module.exports = {
  name: "together",
  description: "Birlikte anlaşmazlık",
  category: "FUN",
...
async function getTogetherInvite(member, choice) {
  ...
  if (!vc) return "Bu komutu kullanmak için bir ses kanalında olmalısınız.";

  if (!discordTogether.includes(choice)) {
    return `Geçersiz Oyun.\nGeçerli Oyunlar: ${discordTogether.join(", ")}`;
  }
