...
module.exports = {
  name: "filtre",
  description: "Sağlanan resme filtre ekleyin",
  cooldown: 5,
  category: "IMAGE",
  ...
  slashCommand: {
    ...
    options: [
      ...
      {
        name: "user",
        description: "filtrenin avatarına ihtiyaç duyduğu kullanıcı",
        type: ApplicationCommandOptionType.User,
        required: false,
      },
      {
        name: "link",
        description: "filtrenin uygulanması gereken resim bağlantısı",
        type: ApplicationCommandOptionType.String,
        required: false,
      },
    ],
