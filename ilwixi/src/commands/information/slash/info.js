...
module.exports = {
  ...
  slashCommand: {
    ...
    options: [
      ...
      {
        name: "guild",
        description: "Lonca Bilgisi Alın",
        type: ApplicationCommandOptionType.Subcommand,
      },
      {
        name: "bot",
        description: "Bot bilgilerini alın",
        type: ApplicationCommandOptionType.Subcommand,
      },
      {
        name: "avatar",
        description: "Avatar bilgilerini görüntüler",
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          {
            name: "name",
      ...
      {
        name: "emoji",
        description: "emoji bilgilerini görüntüler",
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          {
            name: "name",
            description: "emojinin adı",
